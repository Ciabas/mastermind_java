	...
	public MainBoardPanel(final MainView mainView) {
		...
		btnSprawdz.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int amountOfRightColors = mainView.getBoard().getPlayerOrder().checkForRightColors(playerOrder, rightOrder);
				boolean[] checkForRightSpots = mainView.getBoard().getPlayerOrder().checkForRightSpots(playerOrder, rightOrder);
